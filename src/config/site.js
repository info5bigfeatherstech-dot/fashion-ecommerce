  ...
  panels: [
    {
      ...
      /** Resolve live from backend; fallback if API miss */
      categoryMatch: 'earrings-studs',
      href: '/shop/earings',
    ...
    },
    {
      ...
      label: 'Office',
      title: 'Office',
      categoryMatch: 'necklace-sets',
      href: '/shop/necklace-sets',
    ...
    },
    {
      ...
      categoryMatch: 'bracelets-bangles',
      href: '/shop/bangles',
