...
export const CRAFTSMANSHIP_INSPECTION = {
  ...
  titleLead: 'The Art of Jewellery ',
  // titleAmp: '&',
  // titleTrail: 'Jewellery',
  heading: 'Artificial Solid Gold Diamonds',
  body: 'Discover beautifully crafted artificial jewellery designed to elevate your everyday style. From delicate minimal pieces to statement styles, find the perfect accessory for every occasion.',
