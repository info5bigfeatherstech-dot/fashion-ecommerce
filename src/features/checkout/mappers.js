...
export function mapCheckoutQuote(payload) {
  ...
  return {
    ...
    freeShippingApplied: Boolean(raw?.freeShippingApplied),
    freeShippingOffer: raw?.freeShippingOffer || null,
    originalDeliveryCharges: toNumber(raw?.originalDeliveryCharges, 0),
    originalFreightInr: toNumber(raw?.originalFreightInr, 0),
    originalCodFeeInr: toNumber(raw?.originalCodFeeInr, 0),
...
export function mapCheckoutConfirm(payload) {
  ...
  return {
    ...
    totals: {
      ...
      freeShippingApplied: Boolean(totalsRaw.freeShippingApplied),
      freeShippingOffer: totalsRaw.freeShippingOffer || null,
      originalDeliveryCharges: toNumber(totalsRaw.originalDeliveryCharges, 0),
      originalFreightInr: toNumber(totalsRaw.originalFreightInr, 0),
