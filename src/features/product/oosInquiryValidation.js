/**
 * Shared email/phone checks for out-of-stock inquiries.
 * Both email and phone are required so restock alerts can go by email,
 * and contact matching can use phone.
 */
